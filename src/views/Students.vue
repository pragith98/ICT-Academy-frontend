<template>
    <div>
        ...
        <v-container>
            <h1 class="title font-weight-black grey--text">STUDENTS</h1>
            <v-row>
        ...
        data(){
            return{
                cardlist:[
                    ...
                    {name:'Student Details', icon:'mdi-account-plus', color:'orange', link:'/Students'}
                ],


                breadcrumbs: [
                    { text: 'Students', disabled: true, href: '/Students' }
                ],
            }
        }
