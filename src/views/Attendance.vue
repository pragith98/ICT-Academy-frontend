<template>
    <div>
        ...
        <v-container>
            <h1 class="title font-weight-black grey--text">ATTENDANCE</h1>
            <v-row>
...
<script>
    ...
    export default{
        ...
        data(){
            return{
                cardlist:[
                    {name:'Mark Attendance', icon:'mdi-checkbox-marked-outline', color:'pink lighten-2', link:'/Attendance'},
                    {name:'Attendance Details', icon:'mdi-view-list', color:'orange', link:'/Attendance'}
                ],


                breadcrumbs: [
                    { text: 'Attendance', disabled: true, href: '/Attendance' }
                ],
            }
        }
