<template>
    <div>
        ...
        <v-container>
            <h1 class="title font-weight-black grey--text">PARENTS</h1>
            <v-row>
...
<script>
    ...
    export default{
        ...
        data(){
            return{
                cardlist:[
                    {name:'Parent Details', icon:'mdi-view-list', color:'orange', link:'/Parents'}
                ],


                breadcrumbs: [
                    { text: 'Parents', disabled: true, href: '/Parents' }
                ],
            }
        }
