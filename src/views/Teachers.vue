<template>
    <div>
        ...
        <v-container>
            <h1 class="title font-weight-black grey--text">TEACHERS</h1>
            <v-row>
        ...
        data(){
            return{
                cardlist:[
                    ...
                    {name:'Teacher Details', icon:'mdi-account-plus', color:'orange', link:'/Teachers'}
                ],


                breadcrumbs: [
                    { text: 'Teachers', disabled: true, href: '/Teachers' }
                ],
            }
        }
