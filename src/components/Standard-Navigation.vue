                    ...
                    <template v-slot:activator="{ on, attrs }">
                        <v-btn icon v-bind="attrs" v-on="on" class="mr-5">
                            <v-list-item-avatar size="40">
                                <v-img src="../assets/icons/staff.jpg"></v-img>
                            </v-list-item-avatar>
                        </v-btn>
                    </template>
        ...
        <v-navigation-drawer v-model="drawer" app color="#263238" dark>
            ...
            <v-card color="#263238" class="pa-4 mt-3" flat>
                <v-card flat class="text-center" color="#455A64" shaped>
                    ...
                    <v-text-field disabled v-model="branch" outlined dense class="px-3"></v-text-field>
        ...
        methods:{
            ...
            showUser(){
                if(this.logedUser){
                    ...
                    this.branch=this.logedUser.employee.branch.branchName
                }
