                ...
                <v-row>
                    <v-col>
                        ...
                        <v-card flat >
                            ...
                            <v-card-title class="heading-1 blue-grey lighten-4  blue-grey--text text--darken-2">Employee Type - Advance Report
                                <v-spacer></v-spacer>
                            ...
                            <v-card-title>
                                <v-select style="width:10px;" @change="getReports()" :items="employeeTypes" v-model="employeeType" outlined dense></v-select>
                                <v-spacer></v-spacer>
...
<script>
    ...
    export default {
        ...
        methods: {
            generatePDF(){
                ...
                autoTable(doc, {
                    body: [
                        [
                        {
                            content: 'Advance Details Report - '+this.employeeType,
                            styles: {
                            halign:'left',
                            fontSize: 14
                            }
            ...
            getReports(){
                var no = 1
                this.axios.get(this.$apiUrl+"/api/v1.0/AdvanceReporting/advances/byEmployeeType",{
                params:{
