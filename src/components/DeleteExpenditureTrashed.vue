        ...
        <v-dialog v-model="dialog" persistent max-width="400px">
            ...
            <v-card>
                <v-container class="text-center">
                    ...
                    <span class="text-h6 text-center">Do you really want to delete <br> <strong>Expenditure ID:"{{payment.expenseID}}"</strong></span>
                </v-container>
    ...
    export default {
        ...
        methods:{
            ...
            deletePaymentDetails(){
                this.loading=true
                this.axios.delete(this.$apiUrl+'/api/v1.0/ExpenditureManagement/expenditures/'+this.payment.expenseID+'/trashed')
                    .then(Response=>{
