<template>
    <div>
        ...
        <v-container>
            ...
            <template>
                <v-card flat>
                    <v-card-title class="heading-1 blue-grey lighten-4  blue-grey--text text--darken-2">Deativated Staff Details</v-card-title>
        ...
        data () {
            return {
                ...
                breadcrumbs: [
                    ...
                    { text: 'DeativatedStaffDetails', disabled: true, href: '/Staff/DeativatedStaffDetails' }
                ],
