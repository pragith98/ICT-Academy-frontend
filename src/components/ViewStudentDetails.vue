        ...
        <v-card-text style="height: 800px;">
            <v-form ref="form" v-model="valid" lazy-validation class="px-5" :readonly="!isEditing">
                ...
                <v-row justify="center" dense >
                    ...
                    <v-col cols="12" md="6" sm="6">
                        <v-text-field placeholder="ex: 0714332332" v-model="parentTp" :rules="tpRules" label="Telephone No." prepend-icon="mdi-phone-classic" required maxlength="10"></v-text-field>
                    </v-col>
