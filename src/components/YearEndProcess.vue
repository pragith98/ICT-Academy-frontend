        ...
        <v-container>
            ...
            <!----------------------------- Alerts ---------------------------------->
                ...
                <v-card flat max-width="750px" style="margin: auto">
                    <v-card-title class="heading-1 blue-grey lighten-4  blue-grey--text text--darken-2">Year End Process</v-card-title>
                    ...
                    <v-row justify="center" style="padding:12px">
                        ...
                        <div class="px-2 mb-5">
                            <v-btn :loading="loading" @click="endProcess()" :disabled="show" block depressed x-large class="primary">End Year <v-icon right>mdi-table-cog</v-icon></v-btn>
                        </div>
                    </v-row>
...
<script>
    ...
    export default {
        ...
        data () {
            return {
                ...
                breadcrumbs: [
                    ...
                    { text: 'Year End Process', disabled: true, href: '/Processes/YearEndProcess' }
                ],
        ...
        methods: {
            ...
            getProcess(){
                this.axios.get(this.$apiUrl+"/api/v1.0/ProcessManagement/processes/showYearEnd").then(Response=>(
            ...
            endProcess(){
                ...
                this.loading=true
                this.axios.post(this.$apiUrl+"/api/v1.0/ProcessManagement/processes/yearEnd",{
