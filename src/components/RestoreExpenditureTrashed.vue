        ...
        <v-dialog v-model="dialog" persistent max-width="400px">
            ...
            <v-card>
                <v-container class="text-center">
                    ...
                    <span class="text-h6 text-center">Do you really want to restore <br> <strong>Expenditure ID:"{{payment.expenseID}}"</strong></span>
                </v-container>
    ...
    export default {
        ...
        methods:{
            restorePaymentDetails(){
                this.loading=true
                this.axios.post(this.$apiUrl+"/api/v1.0/ExpenditureManagement/expenditures/"+this.payment.expenseID+'/restore',{
